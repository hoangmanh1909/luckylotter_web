              ...
              return (
                ...
                >
                  <div>
                    <div style={{ margin: 10 }}
                      onClick={() => {
                        this.props.onPaymentBankDetail("1");
                      }}
                    >
                      <img
              ...
              return (
                ...
                >
                  <div>
                    <div style={{ margin: 10 }}
                      onClick={() => {
                        this.props.onPaymentBankDetail("2");
                      }}
                    >
                      <img
              ...
              return (
                ...
                >
                  <div>
                    <div style={{ margin: 10 }}
                      onClick={() => {
                        this.props.onPaymentBankDetail("3");
                      }}
                    >
                      <img
              ...
              return (
                ...
                >
                  <div>
                    <div style={{ margin: 10 }}
                      onClick={() => {
                        this.props.onPaymentBankDetail("4");
                      }}
                    >
                      <img
    ...
    return (
      <div>
        ...
        <div style={{ marginLeft: 25, marginTop: 10, display: "flex", width: "100%", fontSize: 16, color: "#ba1f25" }}>
          Lưu ý: Số tiền thanh toán mỗi lần tối thiểu là 300.000đ
        </div>
      </div>
    )
  }
