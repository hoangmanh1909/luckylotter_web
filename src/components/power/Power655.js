...
class Power655 extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.tutorialPower !== undefined &&
      nextProps.tutorialPower.data !== undefined
    ) {
      if (nextProps.tutorialPower.data.Code === "00") {
        this.setState({
          tutorialPower: nextProps.tutorialPower.data.Value
        });
      }
    }
    console.log("nextProps", this.state.tutorialPower);
  ...
  RandomAllButton = () => {
    if (this.state.bagitem !== 6) {
      ...
      return (
        <Button className={button.button_primary_full} style={{color:"#FFFFFF"}} disabled={true}>
  ...
  render() {
    return (
      <div className={styles2.container}>
        <Header history={this.props.history} title = "power"/>
            ...
            <div style={{ display: "flex", padding: "4px 0" }}>
              ...
              <div className={styles2.div_group_text}>
                <div className={styles2.div_text_amt}>
                  {this.state.amtPower
                    .toString()
                    .substring(0, this.state.amtPower.toString().length - 9)}
          ...
          <WingBlank style={{ marginLeft: 6, marginRight: 6 }}>
            ...
            <div style={{ padding: 8, marginTop: 8, background: "#FFF" }}>
              ...
              <div
                ...
                onClick={() => this.props.onTutorial(this.state.tutorialPower)}
              >
