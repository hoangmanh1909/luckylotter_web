...
import { Text, Toast } from "antd-mobile";
                ...
                <div>
                  <div className={styles.format_table}>
                    ...
                    <table className={styles.table_center}>
                      <caption style={{margin: '0.3rem'}} align="bottom">Ký hiệu trúng ĐB: {ResultSI}, {`${getWeekdays(date.getDay())}, ${item.DrawDate}`} </caption>
                      <tbody>
                        <tr>
                          <td width="20%" rowSpan={1} style={{ borderRight: '0.1rem solid #cacccd', backgroundColor: '#f1f1f1', borderTopLeftRadius: '1rem' }}>Đặc biệt</td>
                          <td style={{color:'red' ,fontSize: '1.7rem', background: '#f1f1f1', fontWeight: 'bold', borderTopRightRadius: '1rem' }} colSpan={13} >{ResultDB}</td>
                        </tr>
                        <tr >
